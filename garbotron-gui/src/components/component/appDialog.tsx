        ...
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogContent className="sm:max-w-[500px]">
              ...
              <Tabs defaultValue="newapp" className="w-[400px]">
                ...
                <TabsContent value="newapp">Create a new app here.
                <Form {...form}>
                ...
                <TabsContent value="uploadapp">Upload an app here as an .iot file
                  <input type="file" />
                  <DialogFooter>
